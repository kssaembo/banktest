                            ...
                            return (
                              <div
                                ...
                                className={`bg-white p-4 rounded-2xl border-2 flex flex-col items-center text-center justify-between transition-all relative group h-36 ${
                                  isUnlocked ? 'border-amber-400 bg-amber-50/40 shadow-lg shadow-amber-100 ring-2 ring-amber-200' : 'border-gray-200 bg-white shadow-sm hover:border-gray-300 hover:shadow-md'
                                }`}
                              >
                                ...
                                <span className={`text-[9px] font-black ${isUnlocked ? 'text-emerald-600' : 'text-gray-400'}`}>{isUnlocked ? '획득 완료' : '미획득'}</span>
