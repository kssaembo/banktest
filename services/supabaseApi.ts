...
async function deleteEconomyStoryComments(actorId: string, commentIds: string[]): Promise<number> {
    const { data, error } = await supabase.rpc('delete_economy_story_comments', { p_actor: actorId, p_comments: commentIds });
    handleSupabaseError(error, 'deleteEconomyStoryComments');
...
const baseApi = {
    ...
    getEconomyStories, createEconomyStory, setEconomyStoryStatus, getEconomyStoryComments, addEconomyStoryComment, toggleEconomyStoryReaction, deleteEconomyStoryComments, rewardEconomyStoryComments,
